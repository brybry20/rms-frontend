...
// Note: DISTRIBUTORS_LIST removed per user request to use manual input instead of dropdown.
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <Field label="Distributor / Company Name" required>
            <input 
              ...
              onChange={e => setFormData({ ...formData, distributor_name: e.target.value.toUpperCase() })} 
